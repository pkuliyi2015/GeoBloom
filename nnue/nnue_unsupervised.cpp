...
// The unsupervised settings don't require
// model computations, so we can set the model
// beam width to a large number.
// -------------------------------------------------

#include "nnue_avx2_unsupervised.h"
#include <iostream>
#include <fstream>
#include <sstream>
#include <vector>
...
int main(int argc, char *argv[]) {
    ...
    // tree->prune_bits();
    // reset the heads to untrained status
